---
title: 【 HTML 】知识点
date: 2016-10-19 16:51:49
tags: HTML
---

**面试有几点需注意：(来源[寒冬winter](http://weibo.com/wintercn "微博：寒冬winter") | [小小沧海](http://www.cnblogs.com/xxcanghai/p/5205998.html))**
...
> 
2、DOM操作 —— 如何添加、移除、移动、复制、创s建和查找节点等。
> 
...
>详细的使用请参考：[HTML5 离线缓存-manifest简介](http://yanhaijing.com/html/2014/12/28/html5-manifest/)
...
> *  水平居中：给div设置一个宽度，然后添加 margin: 0 auto属性
...
**position的值 relative 和 absolute 定位原点是？**
...
> 为页面中的所有元素生成颜色随机的轮廓线，轮廓线在边框的外部，不占据空间。
...
>（3） 用innerHTML代替 DOM 操作，减少 DOM 操作次数，优化javascript性能。

>（4） 当需要设置的样式很多时设置 className 而不是直接操作 style。

>（5） 少用全局变量、缓存 DOM 节点查找的结果。减少IO读取操作。
